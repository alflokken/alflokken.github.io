...
> For a similar guide on using OpenID Connect (OIDC) with Microsoft Graph, see [this article](https://medium.com/@alf.lokken/powershell-open-id-connect-oidc-authentication-41ff2c1d5e58).
{: .prompt-tip }
